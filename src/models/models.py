...
from src.models.regression import BayesianLinearRegression, GPyRegression
from src.normalization import zero_mean_unit_var_normalization, zero_mean_unit_var_unnormalization
...
class DNGOModel(BaseModel):
    """
    Intended for an ensemble of DNGO.
    """
    # def __enter__(self)
...
class GPModel(BaseModel):
    """
    Accepts any kernel compatible with the GPy library.
    """
